...
INSERT INTO public.syndicator_profiles 
  (id, company_name, company_description, years_in_business, total_deal_volume) 
VALUES
...
INSERT INTO public.investor_profiles 
  (id, accredited_status, minimum_investment, preferred_property_types, risk_tolerance) 
VALUES 
...
VALUES
  (
    ...
    'Multi-Family',
    'Austin, TX',
    50000,  -- minimum_investment is numeric
    18.5,   -- target_irr is numeric
    5,
    25000000,
    'active',
    true,
  ...
  (
    ...
    'Office',
    'San Jose, CA',
    100000,  -- minimum_investment is numeric
    15.0,    -- target_irr is numeric
    7,
    45000000,
    'active',
    false,
  ...
  (
    ...
    'Medical',
    'Denver, CO',
    75000,  -- minimum_investment is numeric
    16.5,   -- target_irr is numeric
    6,
    30000000,
    'active',
    false,
