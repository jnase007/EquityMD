      ...
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 relative">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-white">Find Investment Opportunities</h1>
              <p className="text-white/80 text-sm">Discover institutional-quality real estate deals</p>
            </div>
          </div>
